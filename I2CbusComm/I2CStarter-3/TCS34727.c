...
COLOR_DETECTED Detect_Color(RGB_COLOR_HANDLE_t* RGB_COLOR_Instance){
	...
	if((RGB_COLOR_Instance->R > RGB_COLOR_Instance->B)
			&&(RGB_COLOR_Instance->R > RGB_COLOR_Instance->G))
		return RED_DETECT;
	else if((RGB_COLOR_Instance->G > RGB_COLOR_Instance->B)
			&&(RGB_COLOR_Instance->G > RGB_COLOR_Instance->R))
		return GREEN_DETECT;
	else if((RGB_COLOR_Instance->B > RGB_COLOR_Instance->R)
